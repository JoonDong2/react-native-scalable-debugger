...
- `POST /agent-actions/*` from `react-native-scalable-debugger-agent-actions-plugin` to let an external agent resolve targets, navigate, press, and scroll a connected app
